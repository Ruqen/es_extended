...
Citizen.CreateThread(function()
	...
	exports["ghmattimysql"]:store("INSERT INTO users SET ?", function(storeId)
		NewPlayer = storeId
	end)
	...
	exports["ghmattimysql"]:store("SELECT "..query.." FROM `users` WHERE ?? LIKE ?", function(storeId)
		LoadPlayer = storeId
	end)
end)
...
function loadESXPlayer(identifier, playerId, isNew)
	...
	table.insert(tasks, function(cb)
		exports["ghmattimysql"]:execute(LoadPlayer, {'identifier', {identifier}
		}, function(result)
